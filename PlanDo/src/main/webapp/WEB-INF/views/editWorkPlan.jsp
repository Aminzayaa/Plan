...
<body>
    ...
    <form action="${pageContext.request.contextPath}/workPlan/update" method="post">
        ...
        <input type="date" name="startDate" value="${plan.startDate}" required>
    
        <label>End Date:</label>
        <input type="date" name="endDate" value="${plan.endDate}" required>
